...
#pragma warning restore RECS0154 // Parameter is never used
		...
		public ColorEnum Key => (ColorEnum)this.GetType().GetProperty("FactoryIntKey", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public).GetValue(null);
	}
...
#pragma warning restore RECS0154 // Parameter is never used
		public static SomeColor Factory(int color) => FactoryInt((int)color);

		public string Content => string.Format("0x{0:X6}", Key);
		public int Key => (int)this.GetType().GetProperty("FactoryIntKey", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public).GetValue(null);
	}
